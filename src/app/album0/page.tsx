        ...
        <section className="grid lg:grid-cols-2 gap-12 md:gap-20 items-start mb-24 md:mb-40">
           ...
           <motion.div variants={FADE_IN_UP} initial="initial" whileInView="whileInView" className="relative group max-w-2xl mx-auto lg:mx-0">
              ...
              <div className="relative aspect-square rounded-2xl md:rounded-3xl overflow-hidden border border-white/5 shadow-2xl">
                <Image
                  src={ALBUM_INFO.coverUrl}
                  alt="290 — Album 0 цомгийн нүүр"
                  fill
           ...
           {/* Right: Info Cards */}
           <motion.div variants={FADE_IN_UP} initial="initial" whileInView="whileInView" className="space-y-8 md:space-y-12">
              <div>
                <h3 className="text-sm md:text-base font-black italic tracking-[0.02em] text-[#FFC107] mb-4">
  Нэрний утга
</h3>
                <p className="text-xl md:text-3xl font-light leading-relaxed text-gray-300 italic">“{ALBUM_INFO.meaning}”</p>
              </div>
              <div className="grid sm:grid-cols-2 gap-6 md:gap-8">
                <div className="p-8 rounded-[2rem] bg-white/[0.02] border border-white/5 backdrop-blur-sm group">
                  ...
                  <p className="text-xs leading-relaxed text-gray-400 font-medium">{ALBUM_INFO.coverStory}</p>
                </div>
                <div className="p-8 rounded-[2rem] bg-[#FFC107]/[0.03] border border-[#FFC107]/10 backdrop-blur-sm group">
                  ...
                  <p className="text-xs leading-relaxed text-gray-400 font-medium">{ALBUM_INFO.process}</p>
                </div>
              </div>
           </motion.div>
        </section>
        ...
        <section className="mb-24 md:mb-40">
          <div className="flex items-end justify-between mb-8 md:mb-12 border-b border-white/10 pb-6 md:pb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[#FFC107] text-[10px] md:text-xs font-bold tracking-[0.3em] uppercase mt-1">Total {ALBUM_INFO.totalTracks} songs</p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-x-12 lg:gap-x-20">
            <AnimatePresence initial={false}>
              {(isExpanded ? ALBUM_TRACKS : ALBUM_TRACKS.slice(0, 8)).map((track, idx) => (
                <motion.div
                  key={track.id}
          ...
          >
            {isExpanded ? (
              ...
              <>See More Tracks ({ALBUM_TRACKS.length - 8}) <ChevronDown size={16} /></>
            )}
          </motion.button>
        </section>
